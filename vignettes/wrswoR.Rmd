...
If, on the other hand, one of the algorithms is implemented incorrectly,
the null hypothesis will be rejected for many $(i, j)$,
and a large share of the p-values will be very close to 0.
The distribution of the p-values is tested with a simple $\chi^2$ test
after binning.\fxwarning{Rejects if too many observations.}
