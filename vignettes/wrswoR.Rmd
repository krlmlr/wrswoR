...
shown in the following section, but still outperforms the stock implementation
for large values of $n$ and $s$.
...
\fxwarning{Really show the algorithm, page 184}
...
\fxwarning{The case $r=0.01$ is because sampling without replacement includes a mandatory sorting.}
