...
\fxwarning{EfSpir}
describe an extension of this algorithm that uses a reservoir
and requires fewer random variates.
In this extension, each random variate decides how many items are skipped
until the current "least likely" item is removed from the reservoir.
We refer to the original paper for more details including proofs of correctness.
