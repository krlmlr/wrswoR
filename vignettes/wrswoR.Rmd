...
For a proof of correctness we refer to the original paper.
...
\fxwarning{EfSpir}
introduce a variation of this algorithm that uses a reservoir
and requires fewer random variates in this case.
