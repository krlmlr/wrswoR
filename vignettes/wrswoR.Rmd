...
and then sampling from $[0, 1)$ (to choose $l_i$ or $r_i$).
...
Only the former can be fit in the framework of \cref{alg:sample},
the latter is based on arithmetic transformation
