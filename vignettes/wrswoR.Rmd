...
the null hypothesis will be rejected more often than expected,
...
The rank and the squared rank are used as independent variables
for the linear model.
A significant deviation from the identity line in favor of more p-values close to zero
will result in a relatively large, positive, and significant value for the squared rank parameter.
