...
each case.
The following two sections discuss the "with replacement" and the
"without replacement" cases separately.


## With replacement

This case corresponds to repeated selection of $k$ from *the same*
