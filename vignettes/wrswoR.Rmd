...
In this framework, sampling without replacement with nonuniform probabilities
is the hardest problem.
This intuition carries over to actual implementations.
The next two sections separately discuss the "with replacement" and the
