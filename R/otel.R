...
# Calls otel::start_local_active_span() when otel is installed,
# otherwise returns a span object whose methods are no-ops.
# parent.frame() pins the activation scope to the caller of this wrapper so the span ends with the caller,
