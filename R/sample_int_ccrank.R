#'@name sample.int.ccrank
#'@title Weighted sampling without replacement using reservoir sampling
#'  (Rcpp version, using C++ vectors)
#'@description \code{sample.int.ccrank} takes a sample of the specified
...
#'  \code{1:n}.
#'@details The call \code{sample.int.ccrank(n, size, prob)} is equivalent
...
#' @examples
#' s <- sample.int.ccrank(200000, 100000, runif(200000))
