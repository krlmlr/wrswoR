...
#' using the weights defined by `prob`.  The call `sample_int_*(n, size, prob)`
#' is equivalent to `sample.int(n, size, replace = F, prob)`.  (The results will most probably be different for the same random seed,
